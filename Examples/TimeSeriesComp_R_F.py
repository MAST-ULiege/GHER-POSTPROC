...
for mm in mlist:
    ...
    for v in vlist:
        ...
        exec('G1.'+v+"_r4=G1.avgspatial(v+'ksurface',maskin=G1.m4)")
        exec('G1.'+v+"_r5=G1.avgspatial(v+'ksurface',maskin=G1.m5)")
...
for v in vlist: 
    G1a.plotseries([v+'_r5',v+'_r4'] ,figout='compR_'+v, title=v)

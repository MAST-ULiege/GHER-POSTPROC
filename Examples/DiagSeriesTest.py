...
Tmean = N.FluxSeries(flist2D,reg, figsuffix='means',ptype='mean',factor=86400, unit='mmol/m²/d')
Tint  = N.FluxSeries(flist2D,reg, figsuffix='ints' ,ptype='int' ,factor=1e-12, unit='Gmol/d')
...
#np.savetxt('Integrated_ts.txt',Bint.T, header=' '.join(flist2D))
#np.savetxt('Mean_ts.txt',Bint.T, header=' '.join(flist2D))
